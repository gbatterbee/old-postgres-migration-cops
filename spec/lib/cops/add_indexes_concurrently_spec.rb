...
#       add_index :users, :unlock_token, algorithm: :concurrently
#     RUBY
#   end
...
#     corrected_source = autocorrect_source('add_index :users, :unlock_token')

#     expected = 'add_index :users, :unlock_token, algorithm: :concurrently'
